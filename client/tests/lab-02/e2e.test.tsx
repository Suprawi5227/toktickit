...
/**
 * Helper: renders App, runs System Check, then clicks the Alice button to
 * log in. After this helper returns the main tabbed UI is visible.
 */
async function loginWithSystemCheck(user: ReturnType<typeof userEvent.setup>) {
  ...
  // Confirm we're in the main app (the tab button is visible)
